...
embla.on('select', e => {
     ...
     */
    document.querySelector("#__slide > div.flex > div:nth-child(1) > p.text-white.__text.text-lg.font-semibold").textContent = people[slideInView[0]].name
    document.querySelector("#__slide > div.flex > div:nth-child(1) > p.text-white.text-base.__text.font-semibold.mt-1").textContent = people[slideInView[0]].position
})
